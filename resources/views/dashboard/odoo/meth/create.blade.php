...
@section('title', 'Escritorio: Crear Metodología')

@section('content')
	<div class="forms">
		<div>
			<h1>Crear Metodología</h1>
			<form action="{{ url('/escritorio/odoo/metodologia/almacenar') }}" method="POST" enctype="multipart/form-data">
				<div>
					<label for="title">Título</label>
					<input type="text" name="title" id="title" placeholder="Título del Metodología" autocomplete="off" autofocus value="{{ old('title') }}">
					@if ($errors->has('title'))
